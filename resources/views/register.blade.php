                ...
                <div class="w-full max-w-md mx-auto bg-white/80 dark:bg-slate-900/80 p-8 rounded-xl shadow-lg">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" required class="border border-gray-300 bg-white/30 rounded-lg px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" name="password_confirmation" id="password_confirmation" required class="border border-gray-300 bg-white/30 rounded-lg px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent">
                        </div>
                        <button type="submit" class="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600">Daftar</button>
                    </form>
                    <p class="text-sm text-gray-600 mt-4 text-center">Sudah punya akun? 
